      ...
      <div className="flex flex-col justify-center items-center w-full h-full">
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-1 px-14">
          <div className="shadow-md shadow-[#efefef] hover:scale-110 duration-500 bg-blue-800 max-h-90 m-4">
            <img className="w-50" src="./img/project-1-img.png" alt="The Avengers" />
          ...
          <div className="shadow-md shadow-[#efefef] hover:scale-110 duration-500 bg-blue-800 max-h-90 m-3">
            <img className="w-50" src="./img/project-2-img.png" alt="Bikini Bottom Booking" />
          ...
          <div className="shadow-md shadow-[#efefef] hover:scale-110 duration-500 bg-blue-800 max-h-90 m-4">
            <img className="w-50" src="./img/project-3-img.png" target="_blank" alt="Code Quiz icon" />
          ...
          <div className="shadow-md shadow-[#efefef] hover:scale-110 duration-500 bg-blue-800 items-center m-4">
            <img className="w-full max-h-56" src="./img/project-4-img.png" target="_blank" alt="Weather Dashboard icon" />
          ...
          <div className="shadow-md shadow-[#efefef] hover:scale-110 duration-500 bg-blue-800 items-center max-h-90 m-4">
            <img className="w-full max-h-56" src="./img/project-5-img.png" target="_blank" alt="Work Schedule icon" />
          ...
          <div className="shadow-md shadow-[#efefef] hover:scale-110 duration-500 bg-blue-800 items-center m-4">
            <img className="w-full h-56" src="./img/project-6-img.png" target="_blank" alt="Note Taker icon" />
